...
mod minimax_tests {
    ...
    fn test_minimax_depth_consistency() {
        ...
        println!("Depth 1: {} (score: {})", move_1.to_uci(&game), score_depth_1);
        println!("Depth 2: {} (score: {})", move_2.to_uci(&game), score_depth_2);
        println!("Depth 3: {} (score: {})", move_3.to_uci(&game), score_depth_3);
